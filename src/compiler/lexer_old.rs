...
#[logos(type S = Rc<[u8]>)]
#[logos(extras = (usize, usize, DefaultInterner))]
...
where
    ...
    pub fn new(source: &'source impl AsRef<str>, interner: &S) -> Self {
        Self {
            source: LogosToken::lexer_with_extras(source.as_ref(), (0, 0, &interner)),
            line: 1,
            column: 1,
        }
    }
